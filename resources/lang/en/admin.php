...
return [
    ...
    'dialogs' => [
        ...
        'sendNowDialog' => [
            'title' => 'Warning!',
            'text' => 'Do you really want to send this item now?',
            'yes' => 'Yes, send now.',
            'no' => 'No, cancel.',
            'success_title' => 'Success!',
            'success' => 'Item successfully sent.',
            'error_title' => 'Error!',
            'error' => 'An error has occured.',
        ],
        'publishNowDialog' => [
        ...
        'sendLaterDialog' => [
            'text' => 'Please choose the date when the notification should be sent:',
            'yes' => 'Save',
            'no' => 'Cancel',
            'success_title' => 'Success!',
        ...
        'setPublishingDatesDialog' => [
            'text' => 'Please choose the dates when the item should be published:',
            'from' => 'Published from',
            'to' => 'Published to',
            'yes' => 'Save',
            'no' => 'Cancel',
